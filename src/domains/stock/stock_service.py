...
class StockService:
    ...
    def get_product(
        ...
        try:
            ...
            return ServiceResponse.success_res(
                data=dict(result), message="Product retrieved successfully."
            )
        except Exception as e:
    ...
    def update_stock(
        ...
        try:
            ...
            lock_query = text(
                "SELECT quantity FROM products WHERE code = :code FOR UPDATE"
            )
    ...
    def list_products(
        ...
        try:
            ...
            return ServiceResponse.success_res(
                data=[dict(r) for r in result], message="Products listed successfully."
            )
        except Exception as e:
    ...
    def get_stock_history(
        ...
        try:
            ...
            return ServiceResponse.success_res(
                data=[dict(r) for r in result], message="Movement history retrieved."
            )
        except Exception as e:
    ...
    def get_low_stock(
        ...
        try:
            ...
            return ServiceResponse.success_res(
                data=[dict(r) for r in result], message="Low stock products retrieved."
            )
        except Exception as e:
    ...
    def audit_inventory(
        ...
        try:
            ...
            for entry in audit_data:
                ...
                res = session.execute(
                    text("SELECT quantity FROM products WHERE code = :code"),
                    {"code": code},
                ).scalar()
                if res is None:
                    results.append(
                ...
                if diff != 0:
                    ...
                    session.execute(
                        text(
                            "UPDATE products SET quantity = :qty, updated_at = CURRENT_TIMESTAMP WHERE code = :code"
                        ),
    ...
    def transfer_stock(
        ...
        try:
            res = session.execute(
                text("SELECT quantity FROM products WHERE code = :code"), {"code": code}
            ).scalar()
            if res is None:
                return ServiceResponse.error_res(
                    f"Product {code} not found", "PRODUCT_NOT_FOUND"
