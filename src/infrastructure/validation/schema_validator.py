...
class SchemaValidator:
    ...
    @staticmethod
    def validate_module_schema(session: Session, module_name: str, required_tables: List[str]) -> Tuple[bool, Optional[ServiceResponse]]:
        """
        ...
        try:
            ...
            for table in required_tables:
                ...
                if not result:
                    logger.warning(f"Missing required table {table} for module {module_name}")
